...
from vlm_lora.common.config import VLMModelInput, LoraConfig
from vlm_lora.common.abstracts import VLMMoeBlock

if is_bitsandbytes_available():
    import bitsandbytes as bnb
    from bitsandbytes.nn import Linear4bit, Linear8bitLt
else:
    from vlm_lora.utils import Linear8bitLt, Linear4bit
